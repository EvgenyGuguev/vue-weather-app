<template>
  <div class="text-white mb-8">
    ...
    <div class="data-input text-gray-800">
      <input type="search" id="address" class="form-control w-full rounded-lg outline-none px-2 py-1" placeholder="Введите название города..." />
...
export default {
  ...
  methods: {
    fetchData() {
      fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${this.location.lat}&lon=${this.location.lon}&lang=ru&units=metric&appid=ffafe74dbd0b2046136e543d8dce04e1`)
